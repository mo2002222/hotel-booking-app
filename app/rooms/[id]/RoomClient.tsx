...
//         <p className="text-slate-700 font-semibold mb-4">{room.description}</p>

//         <div className="space-y-2 text-sm">
//           <div className="flex justify-between">
//             <span className="text-slate-700 font-semibold">Room type:</span>
//             <span className="font-medium capitalize">{room.type}</span>
//           </div>
//           <div className="flex justify-between">
//             <span className="text-slate-700 font-semibold">Max guests:</span>
...
//           </div>
//           <div className="flex justify-between">
//             <span className="text-slate-700 font-semibold">Price per night:</span>
...
//             <Button className="bg-blue-700 hover:bg-blue-600 cursor-pointer">Book This Room</Button>
//           </Link>
//         </div>
//       </div>
//     </div>
