    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="relative h-[600px] bg-gradient-to-r from-blue-900 to-blue-700 flex items-center justify-center text-white">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 text-balance">Experience Luxury at LuxeStay</h1>
          <p className="text-xl md:text-2xl mb-8 text-blue-100 text-pretty">
            Discover exceptional comfort and world-class service in the heart of the city
          </p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-slate-800 mb-4">Why Choose LuxeStay?</h2>
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Experience unparalleled comfort with our premium amenities and exceptional service
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              { icon: Coffee, title: "24/7 Room Service", desc: "Gourmet dining delivered to your room" },
              { icon: Waves, title: "Spa & Pool", desc: "Relax in our world-class spa and pool" },
            ].map((feature, index) => (
      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-slate-800 mb-4">Featured Rooms</h2>
            <p className="text-lg text-slate-600">Discover our most popular accommodations</p>
          </div>
            ...
            {featuredRooms.map((room) => (
              <Card key={room.id} className="overflow-hidden hover:shadow-lg transition-shadow">
                <div className="relative">
                  ...
                  {!room.available && <Badge className="absolute top-3 right-3 bg-red-500">Booked</Badge>}
                </div>
                <CardContent className="p-6">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-sm text-slate-600">{room.rating}</span>
                    </div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-slate-400">Experience luxury and comfort at our premium hotel locations worldwide.</p>
            </div>
            ...
            <div>
              ...
              <p className="text-slate-400 mb-4">Stay connected for exclusive offers</p>
              <Button variant="outline" className="border-slate-600 text-slate-400 hover:bg-slate-700 bg-transparent">
